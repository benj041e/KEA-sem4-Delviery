...
df_customers = pd.read_excel(githubpath + "my_shop_data.xlsx", sheet_name="customers", engine='openpyxl',)
df_order = pd.read_excel(githubpath + "my_shop_data.xlsx", sheet_name="order", engine='openpyxl',)
df_employee = pd.read_excel(githubpath + "my_shop_data.xlsx", sheet_name="employee", engine='openpyxl',)
df_products = pd.read_excel(githubpath + "my_shop_data.xlsx", sheet_name="products", engine='openpyxl',)
